...
import com.raulvitorl.cursomc.dto.CategoriaDTO;
import com.raulvitorl.cursomc.services.CategoriaService;
...
public class CategoriaResource {
	...
	public ResponseEntity<Void> insert(@Valid @RequestBody CategoriaDTO objD){
		Categoria obj = service.FromDTO(objD);
